...
if __name__ == "__main__":
    bvh_r = range(512, 16386, 512) + [4, 8, 16, 32, 64, 128, 256]
    bvh_r.sort()
    ...
    calc("performance_bvh",   bvh_r, "-bo", "Кол-во объектов в листе BVH", "Зависимость скорости работы от количества объектов в листе BVH")
